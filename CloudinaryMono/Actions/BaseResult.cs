...
namespace CloudinaryMono.Actions
{
    ...
    public abstract class BaseResult
    {
        ...
        /// </summary>
        public JsonObject JsonObj { get; protected set; }
        ...
        internal static T Parse<T>(HttpWebResponse response) where T : BaseResult, new()
        {
            ...
            if (response != null)
            {
                ...
                using (StreamReader reader = new StreamReader(stream))
                {
                    ...
                    result = ServiceStack.Text.JsonSerializer.DeserializeFromString<T>(s);
					result.JsonObj = ServiceStack.Text.JsonObject.Parse(s);
                }
